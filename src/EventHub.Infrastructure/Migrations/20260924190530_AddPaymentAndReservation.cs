...
{
    /// <inheritdoc />
    public partial class AddPaymentAndReservation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Users_AttendeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Users_AttendeeId",
                        column: x => x.AttendeeId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_AttendeeId_IdempotencyKey",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_AttendeeId",
                table: "Reservations",
                column: "AttendeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_PaymentId_TicketTypeId",
                table: "Reservations",
                columns: new[] { "PaymentId", "TicketTypeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_Status_ReservedUntil",
                table: "Reservations",
